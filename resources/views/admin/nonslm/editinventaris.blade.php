...
<div class="row">
    ...
    <form action="{{ url('inventaris/'.$inventaris->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="tipe_mesin" name="tipe_mesin" value="{{ $inventaris->tipe_mesin }}">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            <label class="form-label">Vendor Kebersihan </label>
            <input type="text" class="form-control" id="vendor_kebersihan" name="vendor_kebersihan" value="{{ $inventaris->vendor_kebersihan }}">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="cover" name="cover" value="{{ $inventaris->cover }}">
        </div>
        <div class="mb-3">
            <label class="form-label">Lokasi </label>
            <input type="text" class="form-control" id="lokasi" name="lokasi" value="{{ $inventaris->lokasi }}">
        </div>
        <div class="mb-3">
