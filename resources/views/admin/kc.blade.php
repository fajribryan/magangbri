...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Kantor Cabang {{ $selectedkc }}</h1>
</div>
    ...
    <div class="scrollable-data">
        <div class="row">
            <div class="col">
                ...
                <div class="col">
                    <a href="{{ route('export.premiskc', ['kc' => $selectedkc]) }}">
                ...
                <tbody>
                    ...
                    <td>
                        @if($row2->fotoseluruhmesin != '')
                            ...
                            {{-- <a href="{{ $row2->fotoseluruhmesin }}" target="_blank">{{ $row2->fotoseluruhmesin }}</a> --}}
                        @else
                            -
                        @endif
                    </td>
                    <td>
                        @if($row2->fotoruangan != '')
                            <img loading="lazy" src="{{ str_replace('open', 'uc', $row2['fotoruangan']) }}" style="width:400px;height:400px;"><br>
                            {{-- <a href="{{ $row2->fotoruangan }}" target="_blank">{{ $row2->fotoruangan }}</a> --}}
                        @else
                            -
                        @endif
                    </td>
                    <td>
                        @if($row2->fotopintu != '')
                            <img loading="lazy" src="{{ str_replace('open', 'uc', $row2['fotopintu']) }}" style="width:400px;height:400px;"><br>
                            {{-- <a href="{{ $row2->fotopintu }}" target="_blank">{{ $row2->fotopintu }}</a> --}}
                        @else
                            -
                        @endif
                    </td>
                    <td>
                        @if($row2->fotopylon != '')
                        <img loading="lazy" src="{{ str_replace('open', 'uc', $row2['fotopylon']) }}" style="width:400px;height:400px;"><br>
                        {{-- <a href="{{ $row2->fotopylon }}" target="_blank">{{ $row2->fotopylon }}</a> --}}
                        @else
                            -
                        @endif
                    </td>
